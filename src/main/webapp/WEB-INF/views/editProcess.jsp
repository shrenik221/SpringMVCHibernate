...
<html>
	...
	<body>
	    <div class="container">
	        ...
	        <form id="user_form" action="editProcess" method="POST">
	            <div class="form-group">
	                ...
	                <input type="text" class="form-control" id="newname" placeholder="New Username" name="newusername">
	            </div>
	            <button id="confirm_user" type="submit" class="btn btn-primary">Edit User</button>
	        </form>
	    </div>
	</body>
</html>